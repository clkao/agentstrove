// ABOUTME: Tests for content-parser: parseContent, isToolOnly, enrichSegments.
// ABOUTME: Validates segment extraction, thinking block merging, and tool call enrichment.
...
function makeMsg(
  overrides: Partial<MessageWithToolCalls> & { content: string },
