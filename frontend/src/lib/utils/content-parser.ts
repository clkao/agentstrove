// ABOUTME: Parses message content into typed segments (text, thinking, tool, code).
// ABOUTME: Handles thinking block merging, tool alias resolution, and inline code span detection.

import type { MessageWithToolCalls, ToolCall } from "../api/types.js";
...
export function isToolOnly(msg: MessageWithToolCalls): boolean {
  const key =
