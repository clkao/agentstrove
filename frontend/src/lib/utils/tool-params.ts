// ABOUTME: Extracts display metadata and fallback content from tool call input_json.
// ABOUTME: Provides rich metadata tags for common tool types (Read, Edit, Bash, Grep, etc).
