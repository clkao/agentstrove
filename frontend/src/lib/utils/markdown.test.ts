// ABOUTME: Tests for markdown renderer: inline formatting, blocks, XSS sanitization.
// ABOUTME: Validates DOMPurify strips dangerous payloads while preserving safe markup.
