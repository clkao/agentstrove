<!-- ABOUTME: Renders a single message with segments dispatched to type-specific components. -->
<!-- ABOUTME: Parses content into text/thinking/tool/code segments via content-parser. -->
<script lang="ts">
